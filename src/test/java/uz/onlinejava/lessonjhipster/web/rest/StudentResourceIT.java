...
import static uz.onlinejava.lessonjhipster.web.rest.TestUtil.createUpdateProxyForBean;
...
class StudentResourceIT {
    ...
    private static final Instant DEFAULT_BIRTH_OF_DAY = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_BIRTH_OF_DAY = Instant.now().truncatedTo(ChronoUnit.MILLIS);
    ...
    public static Student createEntity(EntityManager em) {
        Student student = new Student()
            ...
            .age(DEFAULT_AGE)
            .birthOfDay(DEFAULT_BIRTH_OF_DAY)
    ...
    public static Student createUpdatedEntity(EntityManager em) {
        Student student = new Student()
            ...
            .age(UPDATED_AGE)
            .birthOfDay(UPDATED_BIRTH_OF_DAY)
    ...
    void getAllStudents() throws Exception {
        ...
        restStudentMockMvc
            ...
            .andExpect(jsonPath("$.[*].birthOfDay").value(hasItem(DEFAULT_BIRTH_OF_DAY.toString())))
    ...
    void getStudent() throws Exception {
        ...
        restStudentMockMvc
            ...
            .andExpect(jsonPath("$.birthOfDay").value(DEFAULT_BIRTH_OF_DAY.toString()))
